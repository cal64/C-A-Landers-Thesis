...
Two scripts which generate a series of plots describing information generated by the htseq tool. The two scripts create different plots.

The scripts were called using the following command lines, with inputs and outputs modified as appropriate

```Python
/usr/bin/Rscript bin/countsLog_rnaseq.R countedReads/ Plots/countingQC 

/usr/bin/Rscript bin/library_proportion.R countedReads/ Plots/countingQC /mnt/cgs-fs3/Sequencing/Genome/Pig/ensembl/gtf/Sscrofa10.2/release-85/Sus_scrofa.Sscrofa10.2.85.gtf
```
