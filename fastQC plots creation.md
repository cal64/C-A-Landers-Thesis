...
### Description
Two R scripts (called by v0.3 of pipeline script fastqc_tables_and_plots) which generate a series of plots describing information generated by the fastqc tool. The first creates separate plots for each sample, the second creates summary plots for the entire sample set
